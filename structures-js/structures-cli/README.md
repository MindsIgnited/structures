...
running command...
$ structures (--version)
@kinotic/structures-cli/3.6.0 darwin-arm64 node-v24.14.1
...
_See code: [src/commands/generate.ts](https://github.com/kinotic-ai/kinotic/blob/v3.6.0/src/commands/generate.ts)_
...
_See code: [src/commands/initialize.ts](https://github.com/kinotic-ai/kinotic/blob/v3.6.0/src/commands/initialize.ts)_
...
_See code: [src/commands/synchronize.ts](https://github.com/kinotic-ai/kinotic/blob/v3.6.0/src/commands/synchronize.ts)_
